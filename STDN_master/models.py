...
import ipdb
import STDN_master.attention as attention
...
class models:
    ...
    nbhd_size = 3, nbhd_type = 2, map_x_num = 10, map_y_num = 20, flow_type = 4, output_shape = 2, optimizer = 'adagrad', loss = 'mse', metrics=[]):
        ...
        print("In models.py's stdn!!!!!")
        print("att_lstm_num:", att_lstm_num)
        print("att_lstm_seq_len:", att_lstm_seq_len)
        print("lstm_seq_len:", lstm_seq_len)
        print("nbhd_size:", nbhd_size)
        print("feature_vec_len:", feature_vec_len)
